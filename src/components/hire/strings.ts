...
export const TERRA_STRINGS: Record<Locale, TerraStrings> = {
  it: {
    ...
    metaDesc: 'CMS strutturato e ricerca full-text su scala per archivi documentali. 33.000+ documenti, 12 settimane dalla firma al go-live. Server EU, GDPR, codice in licenza al cliente.',
    eyebrow: 'Piattaforma documentale · Fondazioni · Enti di ricerca · Consorzi',
    h1: 'L\'archivio c\'è. Trovarlo è il problema.',
    deck: 'Abbiamo costruito e consegnato una piattaforma CMS strutturata con ricerca full-text su scala per una fondazione per lo sviluppo sostenibile — 33.000+ documenti, 12 settimane dal contratto al go-live. Se il tuo team cerca i propri materiali su Google, sappiamo come aiutarti.',
    ...
    stack: [
      { n: '01', t: 'CMS strutturato', d: 'Payload CMS, TypeScript-first: bozza e pubblicato separati, live preview, versioning. L\'interfaccia editoriale è costruita attorno ai flussi reali del team — verificata in produzione su un archivio da 33.000+ record.' },
      ...
      { n: '03', t: 'Modulo DocumentAI (add-on)', d: 'Ingestione AI di PDF e pubblicazioni, abstract automatici, ricerca semantica. Attivo in produzione su un archivio da 33.000+ record. Il layer AI usa API esterne — il provider è dichiarato per contratto, i dati del core Terra restano su server EU.' },
    ...
    proofTitle: 'La prova — piattaforma documentale in produzione',
    proofStats: [
      { n: '33.000+', d: 'documenti nell\'archivio' },
      { n: '12 sett.', d: 'dalla firma al go-live' },
      { n: '16 lug 2026', d: 'data di lancio' },
    ],
    proofText: 'Una fondazione per lo sviluppo sostenibile coordina un Forum nazionale con oltre vent\'anni di produzione documentale — l\'archivio precedente non era più navigabile. Abbiamo consegnato in 12 settimane: CMS strutturato, archivio da 33.000+ record, modulo DocumentAI attivo per ricerca semantica.',
    proofCta: '',
    proofHref: '',
  ...
  en: {
    ...
    metaDesc: 'Structured CMS and full-text search at scale for document archives. 33,000+ documents, 12 weeks from contract to go-live. EU server, GDPR, code licensed to the client.',
    ...
    deck: 'We built and delivered a structured CMS platform with full-text search at scale for a sustainable development foundation — 33,000+ documents, 12 weeks from contract to go-live. If your team searches its own materials on Google, we know how to help.',
    ...
    stack: [
      { n: '01', t: 'Structured CMS', d: 'Payload CMS, TypeScript-first: draft and published states, live preview, versioning. The editorial interface is built around the team\'s real workflows — verified in production on a 33,000+ record archive.' },
      ...
      { n: '03', t: 'DocumentAI module (add-on)', d: 'AI ingestion of PDFs and publications, automatic abstracts, semantic search. Live in production on a 33,000+ record archive. The AI layer uses external APIs — the provider is declared by contract, core Terra data stays on EU servers.' },
    ...
    proofTitle: 'The proof — document platform in production',
    proofStats: [
      { n: '33,000+', d: 'documents in the archive' },
      { n: '12 wks', d: 'from contract to go-live' },
      { n: '16 Jul 2026', d: 'launch date' },
    ],
    proofText: 'A sustainable development foundation coordinates a national Forum with over twenty years of documentary output — the previous site could no longer make it accessible. We delivered in 12 weeks: structured CMS, 33,000+ record archive, DocumentAI module live for semantic search.',
    proofCta: '',
    proofHref: '',
