...
> Nota: se cerchi la storia estesa — come è nato il progetto, perché abbiamo scelto questo stack, le scelte tecniche — è in [Il percorso Susdef: dall'ascolto alla proposta che va oltre](/bulletin/percorso-susdef). Questo articolo è solo i numeri.
...
| Dipendenza dal fornitore | **Zero**: codice applicativo consegnato in licenza d'uso a Susdef, con documentazione tecnica completa — per il loro progetto, non per rivendita o sublicenza a terzi. Un altro fornitore può subentrare domani con un HANDOFF.md chiaro. |
