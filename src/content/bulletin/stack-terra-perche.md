...
Il codice applicativo che costruiamo **ti viene consegnato in licenza d'uso** — integralmente, con documentazione tecnica, per l'uso nel tuo progetto. Non per rivendita, sublicenza a terzi o come base di prodotti commerciali estranei. Un altro dev può subentrare con un HANDOFF.md chiaro. Non c'è nessun lock-in verso di noi, e non c'è lock-in verso il CMS (Payload è framework aperto, non licenza commerciale).
