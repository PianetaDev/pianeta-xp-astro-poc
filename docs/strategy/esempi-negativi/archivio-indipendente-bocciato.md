> **BOCCIATO da Max il 22/09/2026 — non pubblicare, non recuperare.** PIA-1517, PR #133 (chiusa). Motivo: la premessa del pezzo (proprietà piena del codice, "nessun lock-in" senza riserve) contraddice la restrizione d'uso commerciale decisa lo stesso giorno — vedi `docs/strategy/offer-stack-terra.md` §1. Testo originale sotto, non modificato, tenuto come esempio negativo.
